...
function buildBookmarks() {
    ...
    // anchor
		...
		// link.setAttribute('target', '_blank'); // this will open website in new tab
		// Item
    ...
    favCircle.classList.add('fav-circle');
		// Favicon
    ...
    favImg.append(favCircle);
		item.append(favImg, linkName);
    link.append(item);
    xContainer.append(closeIcon);
    bookmarkContainer.append(xContainer, link);
